...
func publishQiniu(_address, _scope string, _uname string, _accessKey string, _accessSecret string) (string, error) {
...
func previewQiniu(_address, _scope string, _uname string, _expiry uint64, _accessKey string, _accessSecret string) (string, error) {
    //TODO public是公有的返回公开链接，私有返回一个带有效期的链接
    mac := qbox.NewMac(_accessKey, _accessSecret)
